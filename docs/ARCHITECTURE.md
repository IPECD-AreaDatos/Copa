# Arquitectura del Tablero de Coparticipación y Empleo (IPECD)
...
2. **Transform**: `pandas` es el motor principal aquí.
   ...
   - **Cálculos Reales (Deflactación)**: Ajusta la "Coparticipación" y la "Masa Salarial" usando las tasas del Índice de Precios al Consumidor (IPC) correspondientes a la región NEA para mostrar la *Variación Real*.
...
*   **Coparticipación Bruta**: Total girado por Nación a la provincia.
*   **Coparticipación Neta (o Disponible)**: Es la Coparticipación Bruta menos los *descuentos* pre-acordados por leyes u obligaciones impositivas que Nación le retiene a la provincia antes de darle el líquido. **Este es el KPI principal del tablero.** El factor reductor usado suele ser ~19% por ley.
...
*   **Cobertura Salarial**: Porcentaje que indica cuánto de la coparticipación disponible se utiliza mensualmente/anualmente para pagar los sueldos ($ Masa Salarial / $ Coparticipación Neta).
...
*   **Copa. Esperada vs Efectiva (Brecha)**: Se presupone por la "Ley de Presupuesto" que la provincia recibirá X por mes. La brecha es cuánto más, o menos, recibió de la nación en la realidad versus lo que se le dijo por ley que recibiría.
